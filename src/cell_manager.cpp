...
const CellPreset FIREPRESET(sf::Color(255, 0, 0), {std::make_shared<BurningBehavior>(), std::make_shared<FlamingBehavior>(), std::make_shared<SpreadingBehavior>()});
const CellPreset WOODPRESET(sf::Color(99, 64, 28), {std::make_shared<FlammableBehavior>(1), std::make_shared<StaticBehavior>()});
const CellPreset SMOKEPRESET(sf::Color(55, 55, 55), {});
